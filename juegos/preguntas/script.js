...
//Tema 3 = consonantes
/*1*/{ pregunta: "Completa la palabra", respuestas: ["", "", "", "", ""], respuestaCorrecta: 0, imagen: "img/.png", categoria: "consonantes" },
...
/*12*/{ pregunta: "¿Cuantos hay?", respuestas: ["8", "6", "12", "10", "11"], respuestaCorrecta: 2, imagen: "img/12dino.png", categoria: "numeros" },
  ...
  document.addEventListener('DOMContentLoaded', function() {   
    ...
    // Función para iniciar el juego con la configuración proporcionada desde el formulario
    function startGame(event) {
        event.preventDefault(); // Evita que el formulario se envíe
        const numQuestions = parseInt(document.getElementById('cantidad_preguntas').value);
        const category = document.getElementById('correct-letter').value;
...
// Asignar el evento de inicio de juego al formulario
document.getElementById('game-settings').addEventListener('submit', startGame);

// Función para manejar el evento de clic en el botón "Stop"
document.getElementById('stop-button').addEventListener('click', function() {
    window.location.href = '../../Pagina/juegos.php';
});
  });