...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $tiempo = $_POST['tiempo']; // Duración en segundos
    $figu = $_POST['figura'];
    $figura = 'Figura realizada: ' . $figu;
    ...
    // Calcular el start_time restando la duración de end_time
    ...
    if ($result->num_rows > 0) {
        ...
        $stmt->bind_param("iissss", $id_estudiante, $id_task, $start_time, $end_time, $tiempo, $figura);
...
<script>
    ...
    console.log(<?php echo json_encode($figura); ?>);
</script>
